...
class WaitingListShowUnavailableBooksWindow(tk.Toplevel):
    def __init__(self, parent):
        super().__init__(parent)
        self.db_manager = database_manager.DatabaseManager()

        self.title("Unavailable Books")
        ...
        self.books_data = self.db_manager.execute_query("Select * From books Where Status = 'In Use'")
